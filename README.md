...
```
cd existing_repo
git remote add origin https://gitlab.com/ReadyRectionz/software-containerization.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ReadyRectionz/software-containerization/-/settings/integrations)
